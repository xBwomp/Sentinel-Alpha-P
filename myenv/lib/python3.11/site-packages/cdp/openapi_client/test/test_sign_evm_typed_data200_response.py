...
class TestSignEvmTypedData200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SignEvmTypedData200Response:
        """Test SignEvmTypedData200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignEvmTypedData200Response`
        """
        model = SignEvmTypedData200Response()
        if include_optional:
    ...
    def testSignEvmTypedData200Response(self):
        """Test SignEvmTypedData200Response"""
