...
class TestSendSolanaTransactionRequest(unittest.TestCase):
    """SendSolanaTransactionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendSolanaTransactionRequest:
        """Test SendSolanaTransactionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendSolanaTransactionRequest`
        """
        model = SendSolanaTransactionRequest()
        if include_optional:
            return SendSolanaTransactionRequest(
    ...
    def testSendSolanaTransactionRequest(self):
        """Test SendSolanaTransactionRequest"""
