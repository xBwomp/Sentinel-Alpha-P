...
class TestSignEvmMessage200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SignEvmMessage200Response:
        """Test SignEvmMessage200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignEvmMessage200Response`
        """
        model = SignEvmMessage200Response()
        if include_optional:
    ...
    def testSignEvmMessage200Response(self):
        """Test SignEvmMessage200Response"""
