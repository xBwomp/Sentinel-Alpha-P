...
class SendEvmTransaction200Response(BaseModel):
    """
    SendEvmTransaction200Response
    """ # noqa: E501
    transaction_hash: StrictStr = Field(description="The hash of the transaction, as a 0x-prefixed hex string.", alias="transactionHash")
