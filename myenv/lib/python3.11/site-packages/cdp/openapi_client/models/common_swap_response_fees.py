...
class CommonSwapResponseFees(BaseModel):
    """
    The estimated fees for the swap.
    """ # noqa: E501
    gas_fee: TokenFee | None = Field(default=None, description="The estimated gas fee for the swap.", alias="gasFee")
    protocol_fee: TokenFee | None = Field(default=None, description="The estimated protocol fee for the swap.", alias="protocolFee")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gasFee": TokenFee.from_dict(obj["gasFee"]) if obj.get("gasFee") is not None else None,
            "protocolFee": TokenFee.from_dict(obj["protocolFee"]) if obj.get("protocolFee") is not None else None
        })
        return _obj
