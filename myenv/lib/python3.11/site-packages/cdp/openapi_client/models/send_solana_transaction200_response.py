...
class SendSolanaTransaction200Response(BaseModel):
    """
    SendSolanaTransaction200Response
    """ # noqa: E501
    transaction_signature: StrictStr = Field(description="The base58 encoded transaction signature.", alias="transactionSignature")
    __properties: ClassVar[List[str]] = ["transactionSignature"]
