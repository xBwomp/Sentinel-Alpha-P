...
class CDPEndUserClient {
    ...
    async createEndUser(options) {
        ...
        return (0, toEndUserAccount_js_1.toEndUserAccount)(index_js_1.CdpOpenApiClient, { endUser, projectId: this.projectId });
    }
    /**
    ...
    async revokeDelegationForEndUser(options) {
        ...
        const { userId } = options;
        await index_js_1.CdpOpenApiClient.revokeDelegationForEndUser(this.requireProjectId(), userId, {});
    }
    ...
    async signEvmTransaction(options) {
        ...
        return index_js_1.CdpOpenApiClient.signEvmTransactionWithEndUserAccount(this.requireProjectId(), options.userId, {
            address: options.address,
    ...
    async signEvmMessage(options) {
        ...
        return index_js_1.CdpOpenApiClient.signEvmMessageWithEndUserAccount(this.requireProjectId(), options.userId, {
            address: options.address,
    ...
    async signEvmTypedData(options) {
        ...
        return index_js_1.CdpOpenApiClient.signEvmTypedDataWithEndUserAccount(this.requireProjectId(), options.userId, {
            address: options.address,
    ...
    async sendEvmTransaction(options) {
        ...
        return index_js_1.CdpOpenApiClient.sendEvmTransactionWithEndUserAccount(this.requireProjectId(), options.userId, {
            address: options.address,
            transaction: options.transaction,
    ...
    async sendEvmAsset(options) {
        ...
        return index_js_1.CdpOpenApiClient.sendEvmAssetWithEndUserAccount(this.requireProjectId(), options.userId, options.address, asset, {
            to: options.to,
    ...
    async sendUserOperation(options) {
        ...
        return index_js_1.CdpOpenApiClient.sendUserOperationWithEndUserAccount(this.requireProjectId(), options.userId, options.address, {
            network: options.network,
            calls: options.calls,
            useCdpPaymaster: options.useCdpPaymaster,
            paymasterUrl: options.paymasterUrl,
    ...
    async createEvmEip7702Delegation(options) {
        ...
        return index_js_1.CdpOpenApiClient.createEvmEip7702DelegationWithEndUserAccount(this.requireProjectId(), options.userId, {
            address: options.address,
            network: options.network,
    ...
    async signSolanaMessage(options) {
        ...
        return index_js_1.CdpOpenApiClient.signSolanaMessageWithEndUserAccount(this.requireProjectId(), options.userId, {
            address: options.address,
            message: options.message,
        });
    }
    ...
    async signSolanaTransaction(options) {
        ...
        return index_js_1.CdpOpenApiClient.signSolanaTransactionWithEndUserAccount(this.requireProjectId(), options.userId, {
            address: options.address,
            transaction: options.transaction,
        });
    }
    ...
    async sendSolanaTransaction(options) {
        ...
        return index_js_1.CdpOpenApiClient.sendSolanaTransactionWithEndUserAccount(this.requireProjectId(), options.userId, {
            address: options.address,
            transaction: options.transaction,
            network: options.network,
        });
    ...
    async sendSolanaAsset(options) {
        ...
        const asset = options.asset ?? "usdc";
        return index_js_1.CdpOpenApiClient.sendSolanaAssetWithEndUserAccount(this.requireProjectId(), options.userId, options.address, asset, {
            to: options.to,
            amount: options.amount,
            network: options.network,
